...
**Status: landed** (C1–C4); the full 19-suite battery passes against the
generated pair. The unity-build cleanup pass (renames + dead code only
clang's single-TU view could see) is recorded in DECISIONS.md.
